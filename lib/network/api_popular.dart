...
class ApiPopular {
  ...
  Future<String> getVideo(int id_popular) async {
    Uri linkES = Uri.parse(
        'https://api.themoviedb.org/3/movie/$id_popular/videos?api_key=89dbf5270b59edd2f28730765b489b9e&language=es-MX');
  ...
  Future<List<ActorModel>?> getAllActors(PopularModel popularModel) async {
    Uri link = Uri.parse(
        'https://api.themoviedb.org/3/movie/${popularModel.id}/credits?api_key=89dbf5270b59edd2f28730765b489b9e');
    var result = await http.get(link);
